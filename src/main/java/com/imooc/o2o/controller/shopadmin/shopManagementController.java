...
public class shopManagementController {
    ...
    @ResponseBody
    private Map<String, Object> getShopLlist(HttpServletRequest request) {
        Map<String, Object> modelMap = new HashMap<String, Object>();
    ...
    private Map<String, Object> registerShop(HttpServletRequest request) {
        ...
        if (shop != null && shopImg != null) {
            ...
            try {
                ...
                if (shopExecution.getState() == ShopStatesEnum.CHECK.getState()) {
                    modelMap.put("success", true);
                    //该用户可以操作的店铺列表
    ...
    private Map<String, Object> modifyShop(HttpServletRequest request) {
        ...
        if (shop != null && shop.getShopId() != null) {
            ...
            try {
                ...
                if (shopExecution.getState() == ShopStatesEnum.SUCCSEE.getState()) {
                    modelMap.put("success", true);
                } else {
                    modelMap.put("success", false);
                    modelMap.put("errMsg", shopExecution.getStateInfo());
...
//            }
//        } catch (Exception e) {
//            throw new RuntimeException("调用fileOutputStream产生异常" + e.getMessage());
//        } finally {
//            try {
...
//                }
//            } catch (Exception e) {
//                throw new RuntimeException("fileOutputStream关闭io产生异常" + e.getMessage());
//            }
//        }
//    }
}
